...
\vspace{10mm}
  {\LARGE \bfseries Zero-Shot Recognition of Generic Objects}\\
   %\vspace{10mm}
   %{\LARGE \bfseries 非負値行列因子分解に基づく声質変換と\\その実用的課題への応用}
}
...
%------------
\include{Intro/introduction}	% background information
\include{Benchmark/benchmark}
\include{Visuals/visuals} %NMF-VC
